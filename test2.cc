/* $Id: test2.cc,v 1.1 2003/10/07 16:42:39 blytkerchan Exp $ */
/* Test for IntHash class
   Copyright (C) 2002
...
int main(void) {
	...
	for (i = 0; i < 100; i++) {
		...
		if ((buffer = (char*)hash->get(i)) != NULL) {
			printf("error\n");
			return(1);
		} // if
	} // for
